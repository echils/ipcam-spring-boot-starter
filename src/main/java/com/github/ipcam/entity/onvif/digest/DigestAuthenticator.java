...
import com.github.ipcam.entity.onvif.digest.fromhttpclient.*;
import okhttp3.*;
...
public class DigestAuthenticator implements CachingAuthenticator {
    ...
    public DigestAuthenticator(CredentialInfo credentials) {
    ...
    private synchronized NameValuePair createDigestHeader(final CredentialInfo credentials, final Request request,
